...
## 项目概述
- 当前已完成 M0.12 + M0.12-R1 + M0.12-R2 + M0.12-R3：子任务交互增强、实时同步、样式保留修复与 checkbox 视觉统一均已落地。
...
## 当前进度
- 已完成：M0 ~ M0.11。
- 已完成：M0.12（子任务交互增强 #1.1~1.3）、M0.12-R1（完成态实时同步修复）、M0.12-R2（重命名样式保留修复）、M0.12-R3（checkbox 视觉统一）。
- 待开始：M1 ~ M4。
