...
const api = {
  invoke: <K extends keyof IpcInvokeMap>(channel: K, payload: Parameters<IpcInvokeMap[K]>[0]) => {
    return ipcRenderer.invoke(channel, payload) as Promise<ReturnType<IpcInvokeMap[K]>>;
  },
